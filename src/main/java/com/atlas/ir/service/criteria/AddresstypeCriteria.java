...
/**
 * Criteria class for the {@link com.atlas.ir.domain.Addresstype} entity. This class is used
 * in {@link com.atlas.ir.web.rest.AddresstypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /addresstypes?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
