...
/**
 * Criteria class for the {@link com.atlas.ir.domain.Customer} entity. This class is used
 * in {@link com.atlas.ir.web.rest.CustomerResource} to receive all the possible filtering options from
...
public class CustomerCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, surname, nationalid, dateofbirth, gender, distinct);
    }
